...
\include{source/9_title}
\newpage
\pagestyle{fancy}
\fancyhead[L]{{\includegraphics[width = 6.0cm]{img/Technik.png}}}
\fancyhead[R]{
	\Large{{
				Formelsammlung\\
				}}}
...
\include{source/0_Allgemein}
\newpage
\pagenumbering{arabic}
\include{source/1_Magnetisches_Feld}
\newpage
\include{source/2_Induktion}
\newpage
\include{source/3_Wechselstromlehre}
\newpage
\include{source/8.sonstiges}
